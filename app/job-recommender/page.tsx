                  ...
                  <div className="grid gap-6">
                    {recommendedJobs.map((job) => (
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                Posted {new Date(job.date_added).toLocaleDateString()}
                              </div>
                              <div className="flex items-center gap-1">
                          ...
                          <div className="flex flex-col items-end gap-2">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => toggleJobDescription(job.job_id)}
                        ...
                        <div className={`mt-4 text-gray-600 dark:text-gray-400 ${!expandedJobs.has(job.job_id) ? 'line-clamp-4' : ''} transition-all duration-200`}>
                          {job.description}
                        </div>
